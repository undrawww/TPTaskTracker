...
/** Sentinel intern_id UUIDs for department-level unassigned task pools */
export const POOL_UUIDS: Record<Department, string> = {
  'Advisor Support Associate': '11111111-1111-1111-1111-111111111111',
  'Business Support Associate': '22222222-2222-2222-2222-222222222222',
  'Client Relations Associate': '33333333-3333-3333-3333-333333333333',
  'Design Content Associate': '44444444-4444-4444-4444-444444444444',
  'BizDev Leadership Team': '55555555-5555-5555-5555-555555555555',
};

export const isPoolId = (id: string) => Object.values(POOL_UUIDS).includes(id);
